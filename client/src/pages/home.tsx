    ...
    <div className="pt-16">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 gradient-text" data-testid="text-impact-title">
              Translating technology into a positive impact
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto" data-testid="text-impact-subtitle">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <Counter
                ...
                data-testid="counter-years"
              />
              <p className="text-gray-400 mt-2" data-testid="text-years-label">Years of Excellence</p>
            </div>
            <div className="text-center">
              <Counter
                target={5}
              ...
              />
              <p className="text-gray-400 mt-2" data-testid="text-projects-label">Projects Completed</p>
            </div>
            <div className="text-center">
              <Counter
                target={10}
              ...
              />
              <p className="text-gray-400 mt-2" data-testid="text-clients-label">Happy Clients</p>
            </div>
            <div className="text-center">
              <Counter
                target={3}
              ...
              />
              <p className="text-gray-400 mt-2" data-testid="text-team-label">Team Members</p>
            </div>
          </div>
        </div>
      </section>
